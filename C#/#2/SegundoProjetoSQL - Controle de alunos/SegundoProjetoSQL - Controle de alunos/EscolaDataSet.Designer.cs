...
namespace SegundoProjetoSQL___Controle_de_alunos.EscolaDataSetTableAdapters {
...
SELECT ID_ALUNO, NOME, TELEFONE, EMAIL, CURSO, NASCIMENTO FROM Alunos WHERE (ID_ALUNO = @ID_ALUNO)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::SegundoProjetoSQL___Controle_de_alunos.Properties.Settings.Default.EscolaConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT        ID_ALUNO, NOME, TELEFONE, EMAIL, CURSO, NASCIMENTO\r\nFROM           " +
            ...
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@curso", global::System.Data.SqlDbType.NVarChar, 50, global::System.Data.ParameterDirection.Input, 0, 0, "CURSO", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual EscolaDataSet.AlunosDataTable RetornarCurso(string curso) {
            this.Adapter.SelectCommand = this.CommandCollection[2];
            if ((curso == null)) {
                throw new global::System.ArgumentNullException("curso");
            }
            else {
                this.Adapter.SelectCommand.Parameters[0].Value = ((string)(curso));
            }
            EscolaDataSet.AlunosDataTable dataTable = new EscolaDataSet.AlunosDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
