...
# Sabendo disso crie uma lambda que recebe um nome como parâmetro e o
# imprime com a primeira letra maiúscula. Esta lambda deverá ser salva dentro
# de uma variável que será passada como argumento de um método chamado
# capitalize_name.
...
first_lambda = -> (name){ puts name.capitalize }
